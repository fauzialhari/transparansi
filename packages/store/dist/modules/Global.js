...
exports.useGlobal = exports.GlobalStoreProvider = void 0;
...
var globalStore = (0, _react.createContext)(initialState);
var Provider = globalStore.Provider;
...
var useGlobal = function useGlobal() {
  return (0, _react.useContext)(globalStore);
};
