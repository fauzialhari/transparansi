...
var _Organization = _interopRequireDefault(require("./pages/Organization"));
...
var Organizations = function Organizations() {
  ...
  return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_reactRouterDom.Switch, null, _react["default"].createElement(_reactRouterDom.Route, {
  ...
  }, "get"), _react["default"].createElement("div", null, loading ? 'loading' : 'tida loading'), organizations.map(function (_ref) {
    var id = _ref.id,
        name = _ref.name;
    return _react["default"].createElement(_cardMedia["default"], {
      ...
      cardActionAreaProps: {
        onClick: function onClick() {
          return history.push("".concat(path, "/").concat(id));
        }
      }
    });
  })), _react["default"].createElement(_reactRouterDom.Route, {
    path: "".concat(path, "/:id")
  }, _react["default"].createElement(_Organization["default"], null))));
};
